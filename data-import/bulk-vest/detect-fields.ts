...
function main() {
  ...
  const vestCols = [
    {
      vestIdx: headerFields.indexOf("vest_2020"),
      fieldIdx: headerFields.indexOf("precinct_field_2020"),
      year: "2020"
    },
    {
      vestIdx: headerFields.indexOf("vest_2018"),
      fieldIdx: headerFields.indexOf("precinct_field_2018"),
      year: "2018"
    },
    {
      vestIdx: headerFields.indexOf("vest_2016"),
      fieldIdx: headerFields.indexOf("precinct_field_2016"),
      year: "2016"
    }
  ];
  ...
  const outputLines = rows.map(row => row.map(v => (v.includes(",") ? `"${v}"` : v)).join(","));
